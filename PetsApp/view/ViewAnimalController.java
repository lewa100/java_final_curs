            ...
            switch (target) {
                ...
                case 2:
                    ...
                    while (true) {
                        ...
                        switch (type) {
                            case 1:
                                    home.addPet(new Cat(pet.getName(), pet.getBirthday(), pet.getCommandList()));
                                break;
                                case 2:
                                    home.addPet(new Dog(pet.getName(), pet.getBirthday(), pet.getCommandList()));
                                break;
                                case 3:
                                    home.addPet(new Hamster(pet.getName(), pet.getBirthday(), pet.getCommandList()));
                                break;
                            default:
                                break;
                        }
